...
/**
 * This class has methods that will create test data based on all the preconditions assumed for NoDeterminationMade determination
...
public class UpdateEligibilityInAppealsBasedOnDeterminationNoDeterminationMade extends TestBase {
	...
	long startTime;
	long endTime;
	public  Class<? extends UpdateEligibilityInAppealsBasedOnDeterminationNoDeterminationMade> clazz = this.getClass();
	@Rule
	...
	/**
	 * This test method will verify that the "No Determination Made" option is NOT available and
	 * verifies that the eligibility = None after  appeals adjudication with Determination = "No Determination Made"
	...
	@Test
	public void testTC17711() throws Exception {
		String ssn = createTestData(CATSProperties.CaseTypeSCI.getProperty(), CATSProperties.CaseTypeSCI.getProperty(), CATSProperties.LevelCodeSCI.getProperty(),CATSProperties.LevelSCI.getProperty(),CATSProperties.AppealDetermiantionNDM.getProperty(),CATSProperties.ExceptionNone.getProperty());
		// Verify in cats
	 ...
	 */
	@Test
	public void testTC17712() throws Exception {
		String ssn = createTestData(CATSProperties.CaseTypeTS.getProperty(), CATSProperties.CaseTypeSCI.getProperty(), CATSProperties.LevelCodeTopSecret.getProperty(),CATSProperties.LevelSCI.getProperty(),CATSProperties.AppealDetermiantionNDM.getProperty(),CATSProperties.ExceptionNone.getProperty());
		// Verify in cats
		verifyCatsEligibility(ssn, "None");
		// Now verify in JVS
		portal_verification(ssn, "None");
	 ...
	 */
	@Test
	public void testTC17713() throws Exception {
		String ssn = createTestData(CATSProperties.CaseTypeSecret1.getProperty(), CATSProperties.CaseTypeSCI.getProperty(), CATSProperties.LevelCodeSecret.getProperty(),CATSProperties.LevelSCI.getProperty(),CATSProperties.AppealDetermiantionNDM.getProperty(),CATSProperties.ExceptionNone.getProperty());
		// Verify in cats
		verifyCatsEligibility(ssn, "None");
		// Now verify in JVS
		portal_verification(ssn, "None");
	 ...
	 */
	@Test
	public void testTC17714() throws Exception {
		String ssn = createTestData(CATSProperties.CaseTypeConfedential.getProperty(), CATSProperties.CaseTypeSCI.getProperty(), CATSProperties.LevelCodeConfidential.getProperty(),CATSProperties.LevelSCI.getProperty(),CATSProperties.AppealDetermiantionNDM.getProperty(),CATSProperties.ExceptionNone.getProperty());
		// Verify in cats
		verifyCatsEligibility(ssn, "None");
		// Now verify in JVS
		portal_verification(ssn, "None");
	 ...
	 */
	@Test
	public void testTC17715() throws Exception {
		String ssn = createTestData1(CATSProperties.CaseTypeSCI.getProperty(),CATSProperties.LevelSCI.getProperty(),CATSProperties.AppealDetermiantionNDM.getProperty(),CATSProperties.ExceptionNone.getProperty());
		// Verify in cats
		verifyCatsEligibility(ssn, "None");
		// Now verify in JVS
		portal_verification(ssn, "None");
	 ...
	 */
	@Test
	public void testTC17767() throws Exception {
		String ssn = createTestData(CATSProperties.CaseTypeSCI.getProperty(), CATSProperties.CaseTypeTS.getProperty(), CATSProperties.LevelCodeSCI.getProperty(),CATSProperties.LevelTopSecret.getProperty(),CATSProperties.AppealDetermiantionNDM.getProperty(),CATSProperties.ExceptionNone.getProperty());
		// Verify in cats
		verifyCatsEligibility(ssn, "None");
		// Now verify in JVS
		portal_verification(ssn, "None");
	 ...
	 */
	@Test
	public void testTC17768() throws Exception {
		String ssn = createTestData(CATSProperties.CaseTypeTS.getProperty(), CATSProperties.CaseTypeTS.getProperty(), CATSProperties.LevelCodeTopSecret.getProperty(),CATSProperties.LevelTopSecret.getProperty(),CATSProperties.AppealDetermiantionNDM.getProperty(),CATSProperties.ExceptionNone.getProperty());
		// Verify in cats
		verifyCatsEligibility(ssn, "None");
		// Now verify in JVS
		portal_verification(ssn, "None");
	 ...
	 */
	@Test
	public void testTC17769() throws Exception {
		String ssn = createTestData(CATSProperties.CaseTypeSecret1.getProperty(), CATSProperties.CaseTypeTS.getProperty(), CATSProperties.LevelCodeSecret.getProperty(),CATSProperties.LevelTopSecret.getProperty(),CATSProperties.AppealDetermiantionNDM.getProperty(),CATSProperties.ExceptionNone.getProperty());
		// Verify in cats
		verifyCatsEligibility(ssn, "None");
		// Now verify in JVS
		portal_verification(ssn, "None");
	 ...
	 */
	@Test
	public void testTC17770() throws Exception {
		String ssn = createTestData(CATSProperties.CaseTypeConfedential.getProperty(), CATSProperties.CaseTypeTS.getProperty(), CATSProperties.LevelCodeConfidential.getProperty(),CATSProperties.LevelTopSecret.getProperty(),CATSProperties.AppealDetermiantionNDM.getProperty(),CATSProperties.ExceptionNone.getProperty());
		// Verify in cats
		verifyCatsEligibility(ssn, "None");
		// Now verify in JVS
		portal_verification(ssn, "None");
	 ...
	 */
	@Test
	public void testTC17771() throws Exception {
		String ssn = createTestData1(CATSProperties.CaseTypeTS.getProperty(),CATSProperties.LevelTopSecret.getProperty(),CATSProperties.AppealDetermiantionNDM.getProperty(),CATSProperties.ExceptionNone.getProperty());
		// Verify in cats
		verifyCatsEligibility(ssn, "None");
		// Now verify in JVS
		portal_verification(ssn, "None");
	 ...
	 */
//	@Test
//	public void testTC17691() throws Exception {
//		String ssn = createTestData(CATSProperties.CaseTypeSCI.getProperty(), CATSProperties.CaseTypeConfedential.getProperty(), CATSProperties.LevelCodeSCI.getProperty(),CATSProperties.LevelConfidential.getProperty(),CATSProperties.AppealDetermiantionNDM.getProperty(),CATSProperties.ExceptionNone.getProperty());
//		// Verify in cats
//		verifyCatsEligibility(ssn, "None");
//		// Now verify in JVS
//		portal_verification(ssn, "None");
//	}
	 ...
	 */
	@Test
	public void testTC17692() throws Exception {
		String ssn = createTestData(CATSProperties.CaseTypeTS.getProperty(), CATSProperties.CaseTypeConfedential.getProperty(), CATSProperties.LevelCodeTopSecret.getProperty(),CATSProperties.LevelConfidential.getProperty(),CATSProperties.AppealDetermiantionNDM.getProperty(),CATSProperties.ExceptionNone.getProperty());
		// Verify in cats
		verifyCatsEligibility(ssn, "None");
		// Now verify in JVS
		portal_verification(ssn, "None");
	 ...
	 */
	@Test
	public void testTC17693() throws Exception {
		String ssn = createTestData(CATSProperties.CaseTypeSecret1.getProperty(), CATSProperties.CaseTypeConfedential.getProperty(), CATSProperties.LevelCodeSecret.getProperty(),CATSProperties.LevelConfidential.getProperty(),CATSProperties.AppealDetermiantionNDM.getProperty(),CATSProperties.ExceptionNone.getProperty());
		// Verify in cats
		verifyCatsEligibility(ssn, "None");
		// Now verify in JVS
		portal_verification(ssn, "None");
	 ...
	 */
	@Test
	public void testTC17695() throws Exception {
		String ssn = createTestData1(CATSProperties.CaseTypeConfedential.getProperty(),CATSProperties.LevelConfidential.getProperty(),CATSProperties.AppealDetermiantionNDM.getProperty(),CATSProperties.ExceptionNone.getProperty());
		// Verify in cats
		verifyCatsEligibility(ssn, "None");
		// Now verify in JVS
		portal_verification(ssn, "None");
	 ...
	 */
	@Test
	public void testTC17792() throws Exception {
		String ssn = createTestData(CATSProperties.CaseTypeSCI.getProperty(), CATSProperties.CaseTypeSecret1.getProperty(), CATSProperties.LevelCodeSCI.getProperty(),CATSProperties.LevelSecret.getProperty(),CATSProperties.AppealDetermiantionNDM.getProperty(),CATSProperties.ExceptionNone.getProperty());
		// Verify in cats
		verifyCatsEligibility(ssn, "None");
		// Now verify in JVS
		portal_verification(ssn, "None");
	 ...
	 */
	@Test
	public void testTC17793() throws Exception {
		String ssn = createTestData(CATSProperties.CaseTypeTS.getProperty(), CATSProperties.CaseTypeSecret1.getProperty(), CATSProperties.LevelCodeTopSecret.getProperty(),CATSProperties.LevelSecret.getProperty(),CATSProperties.AppealDetermiantionNDM.getProperty(),CATSProperties.ExceptionNone.getProperty());
		// Verify in cats
		verifyCatsEligibility(ssn, "None");
		// Now verify in JVS
		portal_verification(ssn, "None");
	...
	@Test
	public void testTC17794() throws Exception {
		String ssn = createTestData(CATSProperties.CaseTypeSecret1.getProperty(), CATSProperties.CaseTypeSecret1.getProperty(), CATSProperties.LevelCodeSecret.getProperty(),CATSProperties.LevelSecret.getProperty(),CATSProperties.AppealDetermiantionNDM.getProperty(),CATSProperties.ExceptionNone.getProperty());
		// Verify in cats
		verifyCatsEligibility(ssn, "None");
		// Now verify in JVS
		portal_verification(ssn, "None");
	 ...
	 */
	@Test
	public void testTC17795() throws Exception {
		String ssn = createTestData(CATSProperties.CaseTypeConfedential.getProperty(), CATSProperties.CaseTypeSecret1.getProperty(), CATSProperties.LevelCodeConfidential.getProperty(),CATSProperties.LevelSecret.getProperty(),CATSProperties.AppealDetermiantionNDM.getProperty(),CATSProperties.ExceptionNone.getProperty());
	 ...
	 */
	@Test
	public void testTC17796() throws Exception {
		String ssn = createTestData1(CATSProperties.CaseTypeSecret1.getProperty(),CATSProperties.LevelSecret.getProperty(),CATSProperties.AppealDetermiantionNDM.getProperty(),CATSProperties.ExceptionNone.getProperty());
	...
	public String createTestData(String caseType, String caseType1, String levelCodeOption,String level,String determination,String exception) throws Exception {
		...
		//Call the appeals adjudication method to verify that NoDeterminationMade is not seen in determination drop down list 
		reusable.appealAdjudicationAsAdjudicator(caseID1,"No Determination Made", level, determination, exception);
	...
	public String createTestData1(String caseType,String level,String determination,String exception) throws Exception {
		...
		//Call the appeals adjudication method to verify that NoDeterminationMade is seen in the drop down list 
		//And grant NoDeterminationMad determination and update the eligibility after adjudication
		reusable.appealAdjudicationAsAdjudicator(caseID,"No Determination Made", level, determination, exception);
	...
	public void portal_verification(String ssn, String eligibility) throws Exception {
		...
		if (eligibility1.contains(eligibility)) {
			...
			System.out.println("Wrong eligibility after Appelas adjudication in PORTAL is seen as " + eligibility1);
		}

...
/**
 * This Test script will update the eligibility based on No Action determination
 ...
 * and new case has been created for the same subject and the same are set in
 * the createTestdata function in the script.
 * 
 * @author vshivaraman
 */

public class UpdateEligibilityBasedOnDeterminationNoAction extends TestBase {
	...
	/**
	 * This test method will verify that the "No Action" option is available and
	 * verifies that the eligibility = SCI after adjudication with determination = No action 
...
//	@Test
//	public void testTC17149() throws Exception {
...
//	}
	...
	/**
	 * This test method will verify that the "No Action" option is available and
	 * verifies that the eligibility = Top Secret after adjudication with Determination = No action
	 ...
	 */
//	@Test
//	public void testTC17150() throws Exception {
...
//	}
	...
	/**
	 * This test method will verify that the "No Action" option is available and
	 * verifies that the eligibility = Secret after adjudication with Determination = No action
	 ...
	 */
//	@Test
//	public void testTC17151() throws Exception {
...
//	}
	...
	/**
	 * This test method will verify that the "No Action" option is available and
	 * verifies that the eligibility = Confidential after adjudication with Determination = No Action
	 ...
	 */
//	@Test
//	public void testTC17152() throws Exception {
...
//	}
	...
	/**
	 * This test method will verify that the "No Action" option is available and
	 * verifies that the eligibility = None after adjudication with Determination = No action 
	 ...
	 */
//	@Test
//	public void testTC17153() throws Exception {
...
//	}
	 ...
	 */
//	@Test
//	public void testTC17182() throws Exception {
...
//	}
	 ...
	 */
//	@Test
//	public void testTC17183() throws Exception {
...
//	}
	 ...
	 */
	@Test
	public void testTC17184() throws Exception {
	 ...
	 */
	@Test
	public void testTC17185() throws Exception {
	 ...
	 */
	@Test
	public void testTC17186() throws Exception {
	 ...
	 */
//	@Test
//	public void testTC17106() throws Exception {
...
//	}
	 ...
	 */
//	@Test
//	public void testTC17107() throws Exception {
...
//	}
	 ...
	 */
//	@Test
//	public void testTC17108() throws Exception {
...
//	}
	 ...
	 */
//	@Test
//	public void testTC17109() throws Exception {
...
//	}
	...
	/**
	 * This test method will verify that the "No Action" option is available and
	 * verify that the eligibility=None after adjudication with determination set to
	 * No action for following condition: Current eligibility is none, Requested
	 * eligibility is Confidential and determination type is No Action.
	 * 
	 * @author vshivaraman
	 * @throws Exception
	 */
//	@Test
//	public void testTC17110() throws Exception {
...
//	}
	 ...
	 */
//	@Test
//	public void testTC17126() throws Exception {
...
//	}
	 ...
	 */
//	@Test
//	public void testTC17127() throws Exception {
...
//	}
	 ...
	 */
//	@Test
//	public void testTC17128() throws Exception {
...
//	}
	 ...
	 */
//	@Test
//	public void testTC17129() throws Exception {
...
//	}
	 ...
	 */
//	@Test
//	public void testTC17130() throws Exception {
...
//	}
	...
	public String createTestData(String caseType, String caseType1, String levelCodeOption) throws Exception {
		...
		// Verify that No Action is seen in the drop down list
		ReusableFunctions.verifyTextFromDropdown1(By.xpath("//*[@id='majorTabPanel:adjPanel:adjudicationTabId:adjudicationDeterminationCodeId_panel']/div/ul"), "No Action");
		System.out.println(" No Action is seen in the drop down list");
		
		// Call the determination not favorable method to set the determination
		// as No Action and close the case
		reusable.determinationsNotFavorable(caseID1, CATSProperties.DeterminationNoAction.getProperty(),CATSProperties.AllegiancePanel.getProperty(),CATSProperties.DisqualifyingCondition.getProperty(),CATSProperties.CivilianMPCCode.getProperty());
	...
	public String createTestData1(String caseType) throws Exception {
		...
		// Call the determination not favorable method to set the determination
		// as No Action and close the case
		reusable.determinationsNotFavorable(caseID, CATSProperties.DeterminationNoAction.getProperty(),CATSProperties.AllegiancePanel.getProperty(),CATSProperties.DisqualifyingCondition.getProperty(), CATSProperties.CivilianMPCCode.getProperty());

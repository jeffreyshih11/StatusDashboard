...
public class TestBase {
	...
	public static void initialize() throws Exception {
		...
		if (driver == null) {
			...
			fn = new FileInputStream(System.getProperty("user.dir") + "//src//config//AutoOR.properties");
			AutoOR.load(fn);
			
			//Initialize and load PreconditionVariables.properties file
			PreconditionVariables = new Properties();
			fn = new FileInputStream(System.getProperty("user.dir") + "//src//config//PreconditionVariables.properties");

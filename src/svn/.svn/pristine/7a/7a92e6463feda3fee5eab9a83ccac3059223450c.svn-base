...
public class CATSSmokeTest extends TestBase {
	...
	public Class<? extends CATSSmokeTest> clazz = this.getClass();
	@Rule
	...
	public void catsSmokeTest() throws Exception {
		...
		Map<String, UserInfo> roleToUserInfomap = new HashMap<String, CATSSmokeTest.UserInfo>();
	...
	public List<UserInfo> createTestData(SSNFNameAndLName sub) throws Exception {
		...
		// Create ITTFScreener
		uInfo = new UserInfo();
		uInfo.leftNavLinks="Communications,Unread Notifications,Case Inbox,Search SMOs";//ITTF Inbox - Removed in Release 5.4
		...
		uInfo = new UserInfo();
		uInfo.leftNavLinks="Communications,Unread Notifications,Case Inbox,Search SMOs";//QC Inbox - Removed in Release 5.4
 ...
 */
	public void verifySubjectdetails(String ssn) throws Exception {
		...
		com.iworks.DISS.test.common.functions.ReusableFunctions.waitAndVerify_IfContains(CATSProperties.Container2.getProperty(), "HSPD12 and Suitability Determinations");
		com.iworks.DISS.test.common.functions.ReusableFunctions.waitAndVerify_IfContains(CATSProperties.Container2.getProperty(), "Investigations");
		...
		com.iworks.DISS.test.common.functions.ReusableFunctions.waitAndVerify_IfContains("//*[@id='majorTabPanel:subjtabview:incidentsDataTable_head']", "Self Reported");
		com.iworks.DISS.test.common.functions.ReusableFunctions.waitUntilElementExistsAndClick(By.partialLinkText("Other Subject Details"));
 ...
 */
	public void verifyCaseDetails(String caseID) {
		...
		com.iworks.DISS.test.common.functions.ReusableFunctions.waitAndVerify_IfContains(CATSProperties.container2.getProperty(), "Insider Threat Issues");
		...
		com.iworks.DISS.test.common.functions.ReusableFunctions.waitAndVerify_IfContains(CATSProperties.container2.getProperty(), "Type");
		com.iworks.DISS.test.common.functions.ReusableFunctions.waitAndVerify_IfContains(CATSProperties.container2.getProperty(), "Status");
